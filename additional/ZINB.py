'''
This code is borrowed from scVI (https://github.com/romain-lopez/scVI-reproducibility)
'''
...
class ZINB(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, n_components=10, learn_V=True):
        ...
        ro.r["library"]("BiocParallel")
        # print("****** begin ******")
        ro.r("serialParam <- SerialParam()")
        ro.r("multicoreParam <- MulticoreParam(workers = 8)")
        ro.r("register(multicoreParam)")
        ro.r("registered()")
        # print("****** end ******")
